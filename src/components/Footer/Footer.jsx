  ...
  return (
    <footer>
     ...
     <ul className="permalinks"> 
      ...
      <a href="https://github.com/VaibhavMali001" target='_blank'><BsGithub size={16}/></a>
      <a href="https://twitter.com/vaibhavmali_01" target='_blank'><BsTwitter   size={17}/></a>
      </div>

      <div className="footer__copyright">
        <small>&copy; <span className="footer-name">Vaibhav Mali.</span> All rights reserved</small>
      </div>
    </footer>
  )
}
